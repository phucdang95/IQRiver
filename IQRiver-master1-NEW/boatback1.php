...
<html>
    <head>
        <link rel='stylesheet' type='text/css' href='boatback1.css' />
    ...
    <div class="image">        
 <a href=".php"><img class="boat2" src="images/sailing.png" alt=""></a>
 <a href=""><img class="cabbage" src="images/cabbage.png" alt=""></a>
 <a href="sheep1.php"><img class="sheep" src="images/sheep.png" alt=""></a>
